	...
	for i = 1, tonumber(sgd_m.Text) do
		...
		if sgd_a.Image == 'http://www.roblox.com/asset/?id=4893785781' then
		    ...
		    if _1 == _2 then
		       ...
		       plr.Character.HumanoidRootPart.CFrame = CFrame.new(-79.1455536, 51.1, -91.2797852, 0.829343677, 5.03827451e-08, -0.558738828, -4.25581383e-08, 1, 2.70026366e-08, 0.558738828, 1.38441958e-09, 0.829343677)
		       wait(0.1)
